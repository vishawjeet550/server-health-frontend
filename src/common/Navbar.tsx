                ...
                <div className="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                    ...
                    <ul className="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                        ...
                        <li className="flex items-center pl-4 xl:hidden">
                            <div className="block p-0 transition-all ease-nav-brand text-sm text-slate-500" sidenav-trigger="">
                        ...
                        <li className="flex items-center px-4">
                            <div className="p-0 transition-all text-sm ease-nav-brand text-slate-500">
                        ...
                        <li className="relative flex items-center pr-2">
                            ...
                            <div className="block p-0 transition-all text-sm ease-nav-brand text-slate-500" dropdown-trigger="" aria-expanded="false">
                                <IoIosNotifications className="cursor-pointer fa fa-bell" />
                            </div>
                            <Unordered className="text-sm transform-dropdown before:font-awesome before:leading-default before:duration-350 before:ease-soft lg:shadow-soft-3xl duration-250 min-w-44 before:sm:right-7.5 before:text-5.5 pointer-events-none absolute right-0 top-0 z-50 origin-top list-none rounded-lg border-0 border-solid border-transparent bg-white bg-clip-padding px-2 py-4 text-left text-slate-500 opacity-0 transition-all before:absolute before:right-2 before:left-auto before:top-0 before:z-50 before:inline-block before:font-normal before:text-white before:antialiased before:transition-all before:content-['\f0d8'] sm:-mr-6 lg:absolute lg:right-0 lg:left-auto lg:mt-2 lg:block lg:cursor-pointer">
