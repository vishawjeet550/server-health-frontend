...
const ProcessManagement = () => {
    ...
    const handleSearch = useDebounce((term: string, type: string) => {
        console.log('sdvjbdfvbdfkvd', term, type)
    ...
    return (
        <section className="process-wrapper">
            ...
            {!processLoading && !error && <div className="flex gap-4">
                <Table showPagination={true} itemsPerPage={20} className="w-[50%] overflow-scroll" tableColumnWrapper={tableColumnWrapper}
                    headers={processTableHeader} data={processList.user || []}>
